...
class ProductListSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['product_name','category','price','average_rating',
                  'date']
...
class ProductDetailSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id','product_name','category','price','description','category',
                  'active','ratings','average_rating','product_video','reviews','product','date','owner']
...
class CarItemSerializers(serializers.ModelSerializer):
    ...
    class Meta:
        model =CarItem
        fields =['id','product','product_id','qyantity','get_total_price']



class CartSerializers(serializers.ModelSerializer):
    items = CarItemSerializers(read_only=True,many=True)
